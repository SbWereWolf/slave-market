решение первого задания - \src\* и \tests\*

решение второго задания - \sql\*
...
Код написан в стиле самокомментирования, на мой вкус комментарии к нему излишни.

По каждому "архитектурному" решению были возможны всякие варианты, предпочтения заказчика не были заявлены, поэтому было реализовано требование "**Всё, что не описано - на совести и фантазии разработчика!**"
